...
import { NoExtractorError, availableExtractors, extract } from "./extract.ts";
...
function ingest(cwd: string, paths: readonly string[], manifest: Manifest): IngestResult {
...
function libraryLines(manifest: Manifest): string[] {
